// import { useState, useEffect, useRef } from 'react' //Brad's
import { useState, useEffect } from 'react' //Will's
...
function EditListing() {
	...
	const onMutate = (e) => {
		...
		if (!e.target.files) {
			setFormData((prevState) => ({
				...prevState,
				[e.target.id]: boolean ?? e.target.value, // (nullish coalescing) ?? -> if not left, do right
			}))
		}
	}
